...
#include "./trunk/OgreMetaballs/Common.h"
...
class MetaballsFrameListenerAdapter : public ExampleFrameListener
{
public:
	MetaballsFrameListenerAdapter(RenderWindow* win, Camera* cam, DynamicMesh* meshBuilder);
	virtual ~MetaballsFrameListenerAdapter(void);
